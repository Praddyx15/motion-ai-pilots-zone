...
const CollaborationSection = () => {
  ...
  return (
    <section id="collaboration" className="section-padding bg-gradient-to-r from-[#004443]/5 to-[#2e9896]/5">
      <div className="container-width">
        <div className="text-center mb-12">
          ...
          <h3 className="heading-tertiary text-accent mb-8" data-aos="fade-up" data-aos-delay="200">
            Partnerships & Sales
          </h3>
          
          <p className="body-text text-muted-foreground mb-8 text-lg leading-relaxed max-w-4xl mx-auto" data-aos="fade-up" data-aos-delay="400">
          ...
          <p className="body-text text-accent mb-12 text-lg font-medium" data-aos="fade-up" data-aos-delay="600">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {partnerships.map((partnership, index) => (
            ...
            >
              ...
              <h4 className="body-text text-foreground font-medium leading-snug">
                {partnership.title}
              </h4>
            </div>
          ))}

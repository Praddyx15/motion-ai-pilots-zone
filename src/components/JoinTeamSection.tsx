    ...
    <section id="careers" className="section-padding">
      <div className="container-width">
        <div className="text-center mb-12">
          ...
          <h3 className="heading-tertiary text-accent mb-6" data-aos="fade-up" data-aos-delay="200">
          ...
          <div className="max-w-4xl mx-auto mb-8" data-aos="fade-up" data-aos-delay="400">
            <h4 className="heading-tertiary text-accent mb-2">
              Multiple Positions
            </h4>
            <p className="body-text text-muted-foreground mb-4">
              Location: Gurugram
            </p>
            <p className="body-text text-muted-foreground mb-8 leading-relaxed text-lg">
